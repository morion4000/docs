...
- **Visual Editor**: Drag-and-drop interface for easy modifications
- **Code Editor**: Direct HTML, CSS, and JavaScript editing
- **Preview Pane**: Real-time preview of your website
- **Element Inspector**: Analyze and modify specific elements
...
- **Drag and Drop**: Reposition elements on your page
- **Text Editing**: Edit text content directly on the page
- **Image Manipulation**: Resize, crop, and replace images
- **Component Library**: Add pre-built components to your site
...
The editor supports various keyboard shortcuts to improve efficiency:
